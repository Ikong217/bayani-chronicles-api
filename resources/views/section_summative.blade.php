...
@section('title', 'Summative | '.$section->grade_level." - ".$section->section_name)
                ...
                <tbody>
                    @foreach ($quizResults as $result)
                        <tr>
                            ...
                            <td>{{ $result['novel'] }}</td>
                            <td>{{ $result['score'] }}</td>
                            <td>{{ Carbon::parse($result['started'])->format('F j, Y h:i A') }}</td>
                            <td>{{ Carbon::parse($result['finished'])->format('F j, Y h:i A') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
